      ...
      <div className="card p-4 mb-6 flex items-center gap-3">
        <div className="w-10 h-10 rounded-xl flex items-center justify-center"
          ...
          {isPro
            ...
            : <Zap size={20} style={{ color: 'var(--text-light)' }} />}
        </div>
...
export default function BillingPage() {
  return (
    <Suspense fallback={
      <div className="p-6 text-center" style={{ color: 'var(--text-muted)' }}>載入中...</div>
    }>
      <BillingContent />
    </Suspense>
  )
