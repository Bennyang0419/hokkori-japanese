    ...
    <div className="min-h-screen flex items-center justify-center p-4"
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
        ...
        <div className="text-center mb-7">
          ...
          <p className="text-sm mt-1" style={{ color: 'var(--text-muted)' }}>歡迎回到 ほっこり日語</p>
        </div>
        ...
        <form onSubmit={handleEmail} className="space-y-4">
          ...
          <div className="relative">
            <Lock size={16} className="absolute left-3 top-1/2 -translate-y-1/2"
              style={{ color: 'var(--text-light)' }} />
            <input type={showPw ? 'text' : 'password'} placeholder="密碼"
        ...
        <div className="my-5 flex items-center gap-3">
          <div className="flex-1 h-px" style={{ background: 'var(--biscuit)' }} />
          <span className="text-xs" style={{ color: 'var(--text-light)' }}>或</span>
          <div className="flex-1 h-px" style={{ background: 'var(--biscuit)' }} />
        </div>
